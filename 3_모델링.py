...
with con1:
    ...
    with tab3:
        ...
        st.image('C:/Users/1104_6/OneDrive/바탕 화면/고은비 팀프로젝트 관련 논문/자료.png')

    with tab1:
        st.subheader(':small_blue_diamond: 이상치 제거 : 3-sigma')
        with st.expander("Details",expanded=True):
            st.image('C:/Users/1104_6/OneDrive/바탕 화면/고은비 팀프로젝트 관련 논문/이상치.png', width=600)
            st.write('''
        ...
        with st.expander("Details",expanded=True):
            st.image('C:/Users/1104_6/OneDrive/바탕 화면/고은비 팀프로젝트 관련 논문/언더샘플링.png', width=600)
            st.write('''
