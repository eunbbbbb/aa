...
with con1:
    ...
    ''', unsafe_allow_html=True)
        ...
        with st.expander("",expanded=True):
            ...
            with D1:
                st.image('C:/Users/1104_6/Desktop/[고은비]/[고은비]/[공공데이터 분석및 AI챗봇 과정]/팀프로젝트 3차 대시보드/대시보드/pages/__func__/당뇨병원인.jpg', caption='출처 : 질병관리청' )
            with D2:
                st.markdown('''
                            - **비만**
                            - **연령**
    ...
    with tab3:
        ...
        with con3:
            ...
            st.image('C:/Users/1104_6/Desktop/[고은비]/[고은비]/[공공데이터 분석및 AI챗봇 과정]/팀프로젝트 3차 대시보드/대시보드/pages/__func__/다음.png', caption='출처 : 대한당뇨병협회')
        with con4:
            ...
            st.image('C:/Users/1104_6/Desktop/[고은비]/[고은비]/[공공데이터 분석및 AI챗봇 과정]/팀프로젝트 3차 대시보드/대시보드/pages/__func__/다식.png', caption='출처 : 대한당뇨병협회')
        with con5:
            ...
            st.image('C:/Users/1104_6/Desktop/[고은비]/[고은비]/[공공데이터 분석및 AI챗봇 과정]/팀프로젝트 3차 대시보드/대시보드/pages/__func__/다뇨.png', caption='출처 : 대한당뇨병협회')
        con6, con7 = st.columns([0.5,0.5])
        with con6:
            st.subheader(':small_blue_diamond: 전신 증상')
            st.image('C:/Users/1104_6/Desktop/[고은비]/[고은비]/[공공데이터 분석및 AI챗봇 과정]/팀프로젝트 3차 대시보드/대시보드/pages/__func__/전신증상.jpg', caption='출처 : 질병관리청')
        with con7:
            st.subheader(':small_blue_diamond: 기타 증상')
            st.image('C:/Users/1104_6/Desktop/[고은비]/[고은비]/[공공데이터 분석및 AI챗봇 과정]/팀프로젝트 3차 대시보드/대시보드/pages/__func__/기타증상.jpg', caption='출처 : 질병관리청')

    with tab4:
        st.subheader('당뇨병은 혈당 검사로 진단합니다')
        st.subheader(':small_blue_diamond: 당뇨병 진단 기준')
        st.write('다음 중 1개 이상 해당 시 당뇨병으로 진단합니다')
        st.image('C:/Users/1104_6/Desktop/[고은비]/[고은비]/[공공데이터 분석및 AI챗봇 과정]/팀프로젝트 3차 대시보드/대시보드/pages/__func__/그림.png', caption='출처 : 질병관리청', use_column_width=True)
