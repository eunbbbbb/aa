...
# 모델 로드
pred_model = joblib.load('C:/Users/1104_6/[강의자료]/[고은비]/[공공데이터 분석및 AI챗봇 과정]/팀프로젝트 3차 대시보드/대시보드/pages/__func__/pred.pkl')
...
def home_page():
    st.title(':pill: 당뇨 예측')
    st.markdown('___')
    st.subheader(":small_blue_diamond: 건강 검진 결과 사진 업로드 또는 설문조사를 시작해주세요.")
    st.write('결과 사진을 통해 예측을 원하시면 **"The 건강 보험"** 앱에서 건강 검진 결과 조회 클릭 후 검진 결과지를 캡쳐해 업로드 해주세요')
